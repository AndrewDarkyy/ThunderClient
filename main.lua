...
if game.PlaceId == 286090429 or game.PlaceId == 11924224825 then
    while true do end -- investigating a ban message
    loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/dca3e69649ed196af0ac6527f743a0ae.lua"))() -- thunder client
